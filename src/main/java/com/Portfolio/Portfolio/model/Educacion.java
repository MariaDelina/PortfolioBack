...
public class Educacion {
    ...
    public Educacion(Long id, String certificaciones, String info_de_instituto, String url_logo_instituto, String nombre_carrera, Date desde_periodo_ano, Date hasta_periodo_ano){
        this.id=id;
