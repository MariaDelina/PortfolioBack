...
public class Experiencia {  
    ...
    public Experiencia(Long id, String lugar_de_trabajo, String titulo_del_puesto, String url_logo_empresa, String descripcion_de_actividades, Date fecha_de_actividad){
        this.id=id;
